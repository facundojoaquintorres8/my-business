...
export class ProductoService {
    ...
    getPrecioByFecha(id: number, fecha: Date): Observable<HttpResponse<IProducto>> {
        return this.http.get<IProducto>(`${this.resourceUrl}/${id}/getPrecioByFecha/${fecha}`, { observe: 'response' });
    }
}
